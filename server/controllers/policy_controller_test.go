...
func TestPolicySummary(t *testing.T) {
	...
	// 		Name: "test-policy",
	// 	},
	// 	// the status is will not load when creating the instance
	...
	// 	// },
	// }
	// t.Log("the policySummary is")
	// t.Log(prettyPrint(policySummary))

	// unStructMap, err := runtime.DefaultUnstructuredConverter.ToUnstructured(policySummary)
	// if err != nil {
	// 	panic(err)
	// }
	// _, err = client.Resource(policySummaryGVR).Create(context.TODO(), &unstructured.Unstructured{Object: unStructMap}, metav1.CreateOptions{})
	// if err != nil {
	// 	panic(err)
	// }

	// unObj, err := client.Resource(policySummaryGVR).Get(context.TODO(), "test-policy", metav1.GetOptions{})
	// if err != nil {
	// 	panic(err)
	// }
	// t.Log("created unObj from etcd")
	// t.Log(prettyPrint(unObj))
	// createdPolicySummary := &policysummaryv1alpha1.PolicySummary{}
	// err = runtime.DefaultUnstructuredConverter.FromUnstructured(unObj.UnstructuredContent(), createdPolicySummary)
	// if err != nil {
	// 	panic(err)
	// }

	// createdPolicySummary.Status = policysummaryv1alpha1.PolicySummaryStatus{
	// 	Compliant:    0,
	// 	NonCompliant: 1,
	// 	RegionalHubs: []policysummaryv1alpha1.RegionalHubPolicyStatus{
	// 		{
	...
	// 	},
	// }
	// // policySummary.SetResourceVersion(createdPolicySummary.GetResourceVersion())
	// unStructMap, err = runtime.DefaultUnstructuredConverter.ToUnstructured(createdPolicySummary)
	// if err != nil {
	// 	panic(err)
	// }
	// _, err = client.Resource(policySummaryGVR).UpdateStatus(context.TODO(), &unstructured.Unstructured{Object: unStructMap}, metav1.UpdateOptions{})
	// if err != nil {
	// 	panic(err)
	// }

	// // t.Log("created resource from etcd")
	// // t.Log(prettyPrint(createdPolicySummary))

	// // unStructMap, err = runtime.DefaultUnstructuredConverter.ToUnstructured(policySummary)
	// // if err != nil {
	// // 	panic(err)
	// // }
	// // client.Resource(policySummaryGVR).Update(context.TODO(), &unstructured.Unstructured{Object: unStructMap}, metav1.UpdateOptions{})
	...
	// 	panic(err)
	// }
	// t.Log("updated unObj from etcd")
	// t.Log(prettyPrint(unObj))
	// unMap := unObj.UnstructuredContent()
	// updatedPolicySummary := &policysummaryv1alpha1.PolicySummary{}
	// err = runtime.DefaultUnstructuredConverter.FromUnstructured(unMap, updatedPolicySummary)
	// if err != nil {
	// 	panic(err)
	// }
